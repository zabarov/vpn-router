...
docker run --rm -v "$output_dir/sing-box.json:/config.json:ro" ghcr.io/sagernet/sing-box:v1.13.12@sha256:da0e2331395c9025a85fa58892772b4cdbe5f2e530e93defeec3968175d06c6d check -c /config.json
